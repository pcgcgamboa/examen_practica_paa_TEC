...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La televisión nos tantaliza, quedamos como prendados de ella. Este efecto entre mágico y maléfico es obra, creo, del exceso de la luz que con su intensidad nos toma.    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Sábato, 2000)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra resume el efecto de la televisión?</p>",
    "options": [
      "Nociva",
      "Ilusoria",
      "Atractiva",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Al principio, en la isla de Nueva Guinea, donde hace unos 10.000 años se domesticó la caña de azúcar, la gente cogía las cañas y masticaba el tallo hasta sentir la <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> en la lengua. El azúcar era una especie de <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span>, la cura de todos los males, y ocupaba un lugar destacado en los antiguos <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> de la isla.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(National Geographic, 2020)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras completan el párrafo anterior con sentido lógico?</p>",
    "options": [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Disculpen esta <u>impericia</u>, esta torpeza al escribir. Me atropello, nada va en orden. No soy escritor... <br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Víquez, 1994)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra es equivalente a “impericia”?</p>",
    "options": [
      "Desorden",
      "Accidente",
      "Negligencia",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    El chiste es un dicho <u>breve</u>, <u>agudo</u> y <u>gracioso</u> que surge espontáneamente del pueblo; algunos investigadores y autores los recopilan para su publicación.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(de la Torre, 2005)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra sintetiza los términos subrayados?</p>",
    "options": [
      "Sagaz",
      "Burlesco",
      "Ingenioso",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La literatura comprometida está hecha de <u>pruebas</u>, de <u>alegatos</u>, de <u>refutaciones</u>. Leerla puede no causarnos placer, pero nos inclina a asentir o a rechazar.  <br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Castellanos, 1959)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra sintetiza los términos subrayados?</p>",
    "options": [
      "Evidencias",
      "Testimonios",
      "Declaraciones",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Los textos electrónicos presentan nuevas <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> y también nuevos retos que pueden tener gran impacto sobre las <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> que tiene el individuo de comprender lo que lee. La destreza en las nuevas competencias de Internet se convertirá en algo esencial para el futuro <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> de nuestros alumnos.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Asociación Internacional de Lectura, 2001)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras completan el párrafo anterior con sentido lógico?</p>",
    "options": [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Ese texto, sin duda, por sus contenidos, por la manera en que está redactado, por su gran aporte histórico y demás características, promete tener gran <u>envergadura</u> para todos aquellos lectores que logren identificar toda su riqueza.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Elaboración propia)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra es equivalente a “envergadura”?</p>",
    "options": [
      "Calidad",
      "Sentido",
      "Significado",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Actualmente, se desarrolla el vínculo entre seres orgánicos y la tecnología. Precisamente, la bioelectrónica aprovecha directamente el <u>prolífico</u> repertorio de sensores olfativos y el <u>sofisticado</u> sistema nervioso de los insectos para crear biorrobots.    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Hidalgo, 2020)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras se oponen a los términos subrayados?</p>",
    "options": [
      "limitado - básico",
      "amplio - elemental",
      "reducido - complejo",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La localidad aparece por primera vez mencionada en la segunda mitad del siglo IX. De aquellos años quedan sepulcros en los alrededores de la parroquia de San Vicente. Pero sin duda los <u>vestigios</u> más destacados, además de una veintena de casas colgantes, son los de su castillo.    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Luján, 2023)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra es equivalente a \"vestigios\"?</p>",
    "options": [
      "Añicos",
      "Restos",
      "Destrozos",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Dominando la escena central del Egeo, se distingue una constelación de islas a las que los griegos denominaron Cícladas por su disposición en círculo. Después de cinco milenios, el barco sigue siendo el medio utilizado para desplazarse entre las islas griegas. Mikonos es un excelente inicio para un <u>periplo</u> que visite las seis joyas más preciadas de islas habitadas que componen el archipiélago.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Martínez, 2019)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra es equivalente a \"periplo\"?</p>",
    "options": [
      "Paseo",
      "Acceso",
      "Destino",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    En el momento de la fundación de la Roma Quadrata, el latín era una simple habla primitiva y <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> empleada por pastores, campesinos y forajidos soldados rudos; pero, conforme Roma comienza a lograr victoria tras victoria sobre otros pueblos, su idioma comienza a <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> por la misma Italia y fuera de sus fronteras.    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Quirós, 2000)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras completan el párrafo anterior con sentido lógico?</p>",
    "options": [
      "antigua - dividirse",
      "rústica - expandirse",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Ambos lugares (un lago ártico helado y una cueva tropical saturada de gases tóxicos) podrían proporcionar claves para resolver uno de los misterios más antiguos y apasionantes del mundo: ¿hay vida fuera de nuestro planeta? Es posible que la vida en otros mundos, ya sea en nuestro sistema solar o en torno a estrellas distantes, tenga que <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> en océanos cubiertos de hielo, como los de Europa, uno de los satélites de Júpiter, o en cuevas llenas de gases, como las que quizás abundan en Marte. Si encontramos la manera de <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> e identificar en la Tierra formas de vida capaces de <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> en ese tipo de ambientes extremos, estaremos un paso más cerca de hallar vida en otros planetas.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(National Geographic, 2018)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras completan el párrafo anterior con sentido lógico?</p>",
    "options": [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    <div style=\"height: 9.45px;\"></div> El storytelling es el arte de contar una historia y aprovechar todos los elementos de su atmósfera para transmitir sensaciones de una forma inolvidable. Consiste en la capacidad de comunicar ideas con la intención de generar un <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span> emocional que marque al espectador y que dé lugar a un espacio de reflexión. <br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Rodríguez, 2021)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra completa el párrafo anterior con sentido lógico?</p>",
    "options": [
      "vínculo",
      "impacto",
      "ambiente",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">Como parte del uso del ingenio se encuentra también el motivo del disfraz, el cual es usado como <span style=\"display: inline-block; border-bottom: 2px solid #333; width: 75.6px; margin: 0 3px;\"></span>. Un ejemplo de ello es cuando el personaje de Odiseo se disfraza de mendigo en varias ocasiones, no solo a su llegada a Ítaca, sino también antes, durante la guerra de Troya, ciudad en la que entra así como espía y roba el Paladio. <br/><br/><div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Cerdas y Guevara, 2023)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuál palabra completa el párrafo anterior con sentido lógico?</p>",
    "options": [
      "timo",
      "truco",
      "fraude",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    Aunque parezca  <u>paradójico</u>, los mensajes más cotidianos son los más difíciles de descifrar porque el hablante, dada la poca <u>trascendencia</u> del mensaje o la rapidez con que debe pensarlo, no tiene mucho tiempo para reflexionar sobre él. <br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Madrigal, 2011)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿cuáles palabras son equivalentes a \"paradójico\" y \"trascendencia\"?</p>",
    "options": [
      "absurdo - importancia",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\"><div style=\"height: 9.45px;\"></div> El cine permite la reunión de personas de distintos estratos sociales en un mismo lugar. Esto ayuda al público a identificarse como colectivo y a generar catarsis frente a los hechos que han marcado su historia.  Son muchas las películas, son diversas sus intenciones, pero cuando el espectador se enfrenta con un filme que lo conmueve, que cuenta con una narrativa que expone una problemática, entonces la experiencia cinematográfica se convierte en un ejercicio sociológico y psicológico.<br><div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Arbeláez, 2018)</div></div><p style=\"margin-top: 20px;\">Considere los siguientes efectos:<p><br><b>A.</b> Crear una identidad cultural colectiva.</p> <p><b>B.</b> Hacer una crítica sobre la realidad social.</p> <p><b>C.</b> Sensibilizar sobre las experiencias de vida.</p> <p><b>D.</b> Educar al público sobre la vida en sociedad.</p><br> <p>Según el texto, ¿cuáles de los anteriores son efectos del cine en el público?</p>",
    "options": [
      "A y B",
      "A y C",
      "B y D",
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    <div style=\"height: 9.45px;\"></div> Los griegos desarrollaron una visión religiosa naturalista cimentada en los dioses del Olimpo, expresando sus creencias mediante la poesía y la música; cuando despertaron del mito y la fábula, cuestionaron el origen fantástico de sus conocimientos, surgiendo así la filosofía, que tiene, a partir de entonces, su origen en la razón humana y ya no más en las concepciones míticas. <br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Martínez, 2016)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, la filosofía nace en Grecia debido a</p>",
    "options": [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La palabra simpatía hace referencia a la puesta en común de dos individualidades en un intento de sintonizar emocionalmente, sin que por ello nadie deba hacer abstracción de lo que piensa o siente. Podemos afirmar que la simpatía tiene más que ver con la expresión subjetiva de sentimientos y pensamientos, mientras que la empatía busca la comprensión objetiva del mundo interno del otro.<br/>    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Artés, 2021)</div>  </div>  <p style=\"margin-top: 20px;\">Según el texto, ¿en qué se basa la diferencia entre simpatía y empatía hacia otras personas?</p>",
    "options": [
  ...
  },
  {
    ...
    "content": "<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La era de la posverdad  se caracteriza por amoldar los medios de información, y los contenidos, al gusto de los usuarios. Se nos muestra una verdad embellecida y configurada a nuestro gusto, algo que aceptamos como más verdadero que la propia verdad de los hechos.    <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Montoya, 2019)</div>  </div>  <p style=\"margin-top: 20px;\">Una conclusión que se infiere del texto anterior es que</p><br>",
    "options": [
...
},
{
  "id": 100,
  "title": "Embarcaciones",
  "content": "Considere la siguiente lista de palabras:<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\"><center>    crucero - barco - velero - lancha   </center></div>¿Cuál palabra se relaciona con la lista anterior?",
  "options": [
    "Tren",
    "Fragata",
    "Bicicleta",
...
},
{
  ...
  "content": "Considere el siguiente texto:<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    La obra de Klimt se ha identificado con la suntuosa decoración basada en dorados y elementos ornamentales de vivos colores, aunque también con formas encubiertas que indican el carácter de los dibujos en que se inspiraban. Al ser la mujer uno de los temas más recurrentes de Klimt, resulta lógico que el artista representase muchas de las facetas del carácter femenino.  <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Artistas eternos, 2025 )</div>  </div>  <p style=\"margin-top: 20px;\">¿Cómo se estructura el texto anterior?</p>",
  "options": [
...
},
{
  ...
  "content": "Considere las siguientes afirmaciones:<div style=\"background: linear-gradient(to bottom, #e8e8e8 0%, #ffffff 100%); border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin: 15px 0; box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.2); font-style: italic;\">    <b>A.</b> Instagram es el sitio de Internet que acumula más imágenes y no para de crecer.<br/><br/><b>B.</b> Los avances tecnológicos han convertido la producción de información en un acto masivo.<br/><br/><b>C.</b> Los tiempos actuales funcionan a otro ritmo, distinto a la capacidad humana para procesar la información.<br/><br/><b>D.</b> La producción de información no será algo exclusivamente humano, sino que todos los nodos (personas o elementos) conectados a la red serán capaces de emitir información.<br/><br/> <div style=\"text-align: right; margin-top: 10px; font-style: normal; color: #555;\">(Cosials, 2015)</div>  </div>  <p style=\"margin-top: 20px;\">¿Cuál de las afirmaciones anteriores es diferente con respecto al conjunto de ideas?</p>",
  "options": [
      "A", 
      "B", 
      "C", 
